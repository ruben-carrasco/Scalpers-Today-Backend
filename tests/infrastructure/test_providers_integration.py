...
from scalper_today.infrastructure.providers.rapidapi_calendar_provider import RapidApiCalendarProvider
from scalper_today.infrastructure.providers.forexfactory_calendar_provider import ForexFactoryCalendarProvider
from scalper_today.infrastructure.providers.fallback_calendar_provider import FallbackCalendarProvider
...
async def test_fallback_when_primary_fails(settings, mock_http_client):
    ...
    mock_http_client.get.side_effect = [
        ...
        MagicMock(status_code=200, json=lambda: [{"title": "Fallback Event", "date": "2026-04-29T10:00:00Z", "impact": "High"}]) # Fallback call
    ]
