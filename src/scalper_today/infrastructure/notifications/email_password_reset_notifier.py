...
class EmailPasswordResetNotifier(IPasswordResetNotifier):
    ...
    def _build_message(self, email: str, token: str) -> EmailMessage:
        ...
        message["Subject"] = "Código de restablecimiento de Scalpers Today"
        ...
        message.set_content(
            "\n".join(
                [
                    ...
                    f"El código caduca en {self.settings.password_reset_token_expire_minutes} minutos.",
                ]
            )
        )
                        ...
                        <tr>
                          <td style="padding:30px 32px;">
                            <p style="margin:0 0 18px;font-size:16px;line-height:1.55;color:#374151;">
                              Hemos recibido una solicitud para restablecer tu contraseña. Introduce este código en la app:
                            </p>
                            <div style="background:#f3f4f6;border:1px solid #e5e7eb;border-radius:18px;padding:18px 24px;font-family:'SFMono-Regular',Consolas,monospace;font-size:34px;line-height:1.1;color:#111827;text-align:center;letter-spacing:0.22em;font-weight:800;">
                              {token}
                            </div>
                            <p style="margin:20px 0 0;font-size:13px;line-height:1.5;color:#6b7280;">
                              Este código caduca en {self.settings.password_reset_token_expire_minutes} minutos. Si no has solicitado este cambio, puedes ignorar este correo.
                            </p>
                          </td>
                        </tr>
                      </table>
